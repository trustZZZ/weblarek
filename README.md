...
Поля класса:
`products: Set<IProduct>` - хранит множество товаров.
...
Методы класса:
 ...
 `getProductById(id: number): IProduct | undefined` - возвращение товара по id, если такого товара нет, то ubderfined.
...
`validateData(data: IBuyer): Object` - валидация данных.
